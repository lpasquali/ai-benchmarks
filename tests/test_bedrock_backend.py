...
def test_bedrock_normalize_model_name():
    ...
    assert b.normalize_model_name("bedrock/anthropic.claude-v2") == "anthropic.claude-v2"
    assert b.normalize_model_name("aws/amazon.titan-text-express-v1") == "amazon.titan-text-express-v1"
