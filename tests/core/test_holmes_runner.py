...
"""Tests for HolmesDriverClient / HolmesDriverClient.

HolmesDriverClient is now a backward-compatible alias for HolmesDriverClient.
...
def test_ask_calls_transport_with_question_and_model(tmp_path: Path) -> None:
    ...
    runner = HolmesDriverClient(kubeconfig, transport=mock_transport)
...
def test_fetch_model_limits_handles_ollama_error(
    ...
    runner = HolmesDriverClient(kubeconfig, transport=MagicMock())
