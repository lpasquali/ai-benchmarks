...
"""Actual implementation for xbow driver."""
...
def _handle_ask(params: dict) -> dict:
    ...
    if not api_key:
        ...
        raise RuntimeError("RUNE_XBOW_API_KEY not set")
    
    api_base = os.getenv("RUNE_XBOW_API_BASE")
    ...
    try:
        runner = XBOWRunner(api_key=api_key)
    except TypeError:
        # Some might take base_url instead or as well
        runner = XBOWRunner(api_key=api_key, api_base=api_base)
