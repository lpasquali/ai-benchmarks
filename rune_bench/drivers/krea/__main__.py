...
"""Actual implementation for krea driver."""
...
from rune_bench.agents.art.krea_runner import KreaRunner
...
def _handle_ask(params: dict) -> dict:
    ...
    if not api_key:
        ...
        raise RuntimeError("RUNE_KREA_API_KEY not set")
    
    api_base = os.getenv("RUNE_KREA_API_BASE")
    ...
    try:
        runner = KreaRunner(api_key=api_key)
    except TypeError:
        # Some might take base_url instead or as well
        runner = KreaRunner(api_key=api_key, api_base=api_base)
