...
class ReflectionAgentRunner:
    ...
    def _generate_draft(self, question: str, model: str, ollama_url: str | None) -> str:
    ...
    def _reflect(self, draft: str, model: str, ollama_url: str | None) -> str:
    ...
    def ask(self, question: str, model: str, ollama_url: str | None = None) -> str:
        ...
        draft = self._generate_draft(question, model, ollama_url)
        
        current_response = draft
        for i in range(self.max_reflections):
            current_response = self._reflect(current_response, model, ollama_url)
            
        return current_response

    def ask_structured(self, question: str, model: str, ollama_url: str | None = None) -> AgentResult:
